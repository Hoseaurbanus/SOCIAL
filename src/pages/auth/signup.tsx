...
export default function SignupPage() {
  ...
  const onSubmit = async (data: SignupForm) => { console.log('Signup:', data) }
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          <div className="relative">
            ...
            <input type="text" placeholder="Your name" className="w-full h-10 pl-10 pr-4 rounded-lg border border-border bg-bg-primary text-text-primary focus:border-accent focus:ring-2 focus:ring-accent/20 transition-colors" {...register('name')} />
          </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input type="password" placeholder="Create a password" className="w-full h-10 pl-10 pr-4 rounded-lg border border-border bg-bg-primary text-text-primary focus:border-accent focus:ring-2 focus:ring-accent/20 transition-colors" {...register('password')} />
          </div>
        ...
        <div>
          ...
          <div className="relative">
            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-text-tertiary" />
            <input type="password" placeholder="Confirm your password" className="w-full h-10 pl-10 pr-4 rounded-lg border border-border bg-bg-primary text-text-primary focus:border-accent focus:ring-2 focus:ring-accent/20 transition-colors" {...register('confirmPassword')} />
          </div>
