      ...
      <div className="min-h-screen flex items-center justify-center bg-bg-primary px-4">
        <div className="w-full max-w-md space-y-6 text-center">
          <div className="flex justify-center">
            <SmugflexLogo className="h-12 w-auto" />
          </div>
          <div className="flex justify-center">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-primary px-4">
      <div className="w-full max-w-md space-y-6">
        ...
        {error && (
          <div className="p-3 rounded-xl bg-red-500/10 text-red-500 text-sm" role="alert">
            {error}
          </div>
        )}
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <Input id="reset-email" type="email" placeholder="you@example.com" className="pl-10" {...register('email')} aria-describedby={errors.email ? 'reset-email-error' : undefined} />
            </div>
            {errors.email && <p id="reset-email-error" className="mt-1 text-sm text-red-500">{errors.email.message}</p>}
          </div>
